            ...
            switch (ans) {
                case 1:
                    do {
                        ...
                        sigle = sc.nextLine();
                        if (sigle.isEmpty()) {
                            System.out.println("ERREUR ! Il faut rentrer quelque chose");
                            drap = 0;
                        } else {
                    ...
                    break;
                case 2:
                    System.out.println("Quel id du local recherchez vous ? ");
                    int rep = sc.nextInt();
                    locDAO.read(rep);
                    break;
                case 3:
                    System.out.print("Entrez l'id de ce que vous voulez changer : ");
                    id = sc.nextInt();
                    sc.skip("\n");
                    do {
                        drap = 1;
                    ...
                    break;
                case 4:
                    System.out.print("Entrez l'id de ce que vous voulez supprimer : ");
                    id = sc.nextInt();
                ...
                case 6:
                    ...
                    break;
                default:
                    System.out.println("Erreur, le nombre entré est incorrect");
            }
        } while (flag == 0);
